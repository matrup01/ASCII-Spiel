...
class Names:
    ...
    def shieldname(self):
        namelist = ["Gwychardus' Bollwerk","Letzte Hoffnung","Drachenstopper","Schleier der Ahnen","Unheilsfänger","Klingenbrecher", "Distors Schirm"]
    ...
    def daggername(self):
        namelist = ["Seelenschnitter","Sturmflut","Schicksalsdorn","Todeszahn","Oswalds Ende","Seelenernter"]
